...
(function() { this.JST || (this.JST = {}); this.JST["breed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  breeds.forEach(function (breed) { ; __p.push('\n  <li class="filter breed" name="',  (breed) ,'">',  (breed) ,'</li>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/comment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <article class="comments-header">Comments</article>\n  <ul class="comments-list">\n    ');  comments.each(function (comment) { ; __p.push('\n      <li class="comment" id="',  'comment-' + comment.get('id') ,'">\n        ‘',  comment.escape('body') ,'’\n        <br>\n        <section class="byline">\n          -<p class="mail">',  comment.escape('username') ,'</p>\n        </section>\n        ');  if ((userId === listerId) || (userId === comment.get('commenter_id'))) { ; __p.push('\n          <button class="removeComment" name="Remove Comment">Remove Comment</button>\n        ');  } ; __p.push('\n      </li>\n    ');  }) ; __p.push('\n  </ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="new_listing" title="',  listing.isNew() ? 'New Listing' : 'Edit Listing' ,'">\n  <form id="newListing">\n    <fieldset>\n\n      <input type="hidden" id="owner_id" name="owner_id" value="',  userId ,'">\n      <table>\n        <tr>\n          <td><label for="pet_name">Pet\'s Name:</label></td>\n          <td><input class="newListField" type="text" id="pet_name" name="pet_name" value="',  listing.escape('pet_name') ,'">\n          </td>\n        </tr>\n        <tr>\n          <td><label for="species">Animal:</label></td>\n          <td><select class="newListField" id="species" name="species">\n            ');  if (listing.escape('species') === "Cat") { ; __p.push('\n              <option selected>Cat</option>\n            ');  } else { ; __p.push('\n              <option>Cat</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Dog") { ; __p.push('\n              <option selected>Dog</option>\n            ');  } else { ; __p.push('\n              <option>Dog</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Bird") { ; __p.push('\n              <option selected>Bird</option>\n            ');  } else { ; __p.push('\n              <option>Bird</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Rodent") { ; __p.push('\n              <option selected>Rodent</option>\n            ');  } else { ; __p.push('\n              <option>Rodent</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Reptile") { ; __p.push('\n              <option selected>Reptile</option>\n            ');  } else { ; __p.push('\n              <option>Reptile</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Aquatic") { ; __p.push('\n              <option selected>Aquatic</option>\n            ');  } else { ; __p.push('\n              <option>Aquatic</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Amphibian") { ; __p.push('\n              <option selected>Amphibian</option>\n            ');  } else { ; __p.push('\n              <option>Amphibian</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('species') === "Human") { ; __p.push('\n              <option selected>Human</option>\n            ');  } else { ; __p.push('\n              <option>Human</option>\n            ');  } ; __p.push('\n          </select></td>\n        </tr>\n        <tr>\n          <td><label for="breed">Breed/Type:</label></td>\n          <td><input class="newListField" id="breed" type="text" name="breed" value="',  listing.escape('breed') ,'"></td>\n        </tr>\n        <tr>\n          <td><label for="gender">Gender:</label></td>\n          <td><select class="newListField" id="gender" name="gender">\n            ');  if (listing.escape('gender') === "Male") { ; __p.push('\n              <option selected>Male</option>\n            ');  } else { ; __p.push('\n              <option>Male</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('gender') === "Female") { ; __p.push('\n              <option selected>Female</option>\n            ');  } else { ; __p.push('\n              <option>Female</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('gender') === "Transgender") { ; __p.push('\n              <option selected>Transgender</option>\n            ');  } else { ; __p.push('\n              <option>Transgender</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('gender') === "Genderqueer/Androgynous") { ; __p.push('\n              <option selected>Genderqueer/Androgynous</option>\n            ');  } else { ; __p.push('\n              <option>Genderqueer/Androgynous</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('gender') === "Intersex") { ; __p.push('\n              <option selected>Intersex</option>\n            ');  } else { ; __p.push('\n              <option>Intersex</option>\n            ');  } ; __p.push('\n            ');  if (listing.escape('gender') === "Unknown") { ; __p.push('\n              <option selected>Unknown</option>\n            ');  } else { ; __p.push('\n              <option>Unknown</option>\n            ');  } ; __p.push('\n          </select></td>\n        </tr>\n        <tr>\n          <td><label for="age">Age:</label></td>\n          <td><input class="newListField" id="age" type="text" name="age" value="',  listing.escape('age') ,'"></td>\n        </tr>\n        <tr>\n          <td><label for="location">Location:</label></td>\n          <td><input class="newListField" id="location" type="text" name="location" value="',  listing.escape('location') ,'"></td>\n        </tr>\n      </table>\n\n      <label>Picture\n\t\t      <input type="file" id="input-picture-file" name="picture">\n      </label>\n\n      <img src="" id="picture-preview">\n\n      <label>\n        <textarea id="body" name="body" rows="6" cols="32" placeholder="Please enter a detailed description of this pet.">',  listing.escape('body') ,'</textarea>\n      </label>\n\n    </fieldset>\n  </form>\n  <button type="submit" form="newListing"></button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="bodycontainer group">\n\n  <section class="search group">\n    <label>Search\n      <input type="text" class="query" placeholder="Enter search (e.g. \'male dog\')">\n    </label>\n    <ul id="menu">\n      <li class="ui-widget-header">Animal Type</li>\n      <section class="li-species">\n        <li id="Breed" class="filter species" name="Dog">Dog</li>\n        <li id="Breed" class="filter species" name="Cat">Cat</li>\n        <li id="Breed" class="filter species" name="Bird">Bird</li>\n        <li id="Breed" class="filter species" name="Reptile">Reptile</li>\n        <li id="Breed" class="filter species" name="Rodent">Rodent</li>\n        <li id="Breed" class="filter species" name="Amphibian">Amphibian</li>\n        <li id="Breed" class="filter species" name="Aquatic">Aquatic</li>\n        <li id="Breed" class="filter species" name="Human">Human</li>\n        <li class="ui-widget-header">Breed / Type</li>\n      </section>\n      <section id="breed-list">\n        <li class="please-select">Please select an animal type</li>\n      </section>\n        <li class="ui-widget-header">Gender</li>\n        <section id="li-gender">\n          <li class="filter gender" name="Male">Male</li>\n          <li class="filter gender" name="Female">Female</li>\n        </section>\n        <li class="searchFilter" name="Search">Search</li>\n    </ul>\n  </section>\n\n  <section class="listings-body group">\n    <h2 class="listings_header">Adoption Listings</h2>\n    ');  if (userId !== null) { ; __p.push('\n      <div class="nlist">\n        <button class="new_listing" name="Create New Listing">Create New Listing</button>\n      </div>\n    ');  } ; __p.push('\n    <br>\n    <ul class=\'all_listings\'>\n      ');  listings.each(function (listing) {  ; __p.push('\n        <li class=\'listingitem\'>\n          <ul class=\'listing\' data-id=\'',  listing.get('id') ,'\'>\n            <img class="indexImg" src="',  listing.escape("picture_url") ,'"/>\n            <li><strong class="attr">Animal: </strong>',  listing.escape('species') ,'</li>\n            <li><strong class="attr">Pet Name: </strong>',  listing.escape('pet_name') ,'</li>\n            ');  if (listing.escape('breed') !== "")  { ; __p.push('\n              ');  if (listing.escape('species') === "Cat" || listing.escape('species') === "Dog") { ; __p.push('\n                <li><strong class="attr">Breed: </strong>',  listing.escape('breed') ,'</li>\n                ');  } else {; __p.push('\n                <li><strong class="attr">Type: </strong>',  listing.escape('breed') ,'</li>\n                ');  } ; __p.push('\n            ');  } ; __p.push('\n            <li><strong class="attr">Location: </strong>',  listing.escape('location') ,'</li>\n            <li><strong class="attr">Gender: </strong>',  listing.escape('gender') ,'</li>\n            <!-- <li><strong class="attr">Age: </strong>',  listing.escape('age') ,'</li> -->\n            <section class="click2c">Click for more about ',  listing.escape('pet_name') ,'</section>\n          </ul>\n        </li>\n        <br>\n      ');  }) ; __p.push('\n    </ul>\n  </section>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="dialog" title="',  listing.escape('pet_name') ,' the ',  listing.escape('breed') ,'">\n  <section class="listingTop">\n    <table class="table">\n      <tr>\n        <td>Name:</td>\n        <td class="cell">',  listing.escape('pet_name') ,'</td>\n      </tr>\n      <tr>\n        <td>Gender:</td>\n        <td class="cell">',  listing.escape('gender') ,'</td>\n      </tr>\n      <tr>\n        <td>Animal:</td>\n        <td class="cell">',  listing.escape('species') ,'</td>\n      </tr>\n      ');  if (listing.escape('breed') !== "")  { ; __p.push('\n        <tr>\n          ');  if (listing.escape('species') === "Cat" || listing.escape('species') === "Dog") { ; __p.push('\n            <td>Breed:</td>\n            <td class="cell">',  listing.escape('breed') ,'</td>\n          ');  } else {; __p.push('\n            <td>Type:</td>\n            <td class="cell">',  listing.escape('breed') ,'</td>\n          ');  } ; __p.push('\n        </tr>\n      ');  } ; __p.push('\n      ');  if (listing.escape('age') !== "")  { ; __p.push('\n        <tr>\n          <td>Age:</td>\n          <td class="cell">',  listing.escape('age') ,'</td>\n        </tr>\n      ');  } ; __p.push('\n      <tr>\n        <td>Location:</td>\n        <td class="cell">',  listing.escape('location') ,'</td>\n      </tr>\n    </table>\n\n    <img title="Click to enlarge photo." class="listingImg" src="',  listing.escape('picture_url') ,'"/>\n  </section>\n    <section class="listingBody">\n      ',  listing.escape('body') ,'\n    </section>\n    <br>\n    <br>\n    <section class="interested">If you\'re interested in adopting ',  listing.escape('pet_name') ,' please e-mail their caretaker at <p title="This email has been obfuscated and cannot be copied." class="mail">',  listing.escape('email') ,'</p></section>\n    <br>\n    <section class="comments"></section>\n\n  ');  if (userId !== null) { ; __p.push('\n    <section class="addComment">\n      <article class="commentForm">\n        <form class="newCommentForm">\n          <fieldset>\n            <input type="hidden" name="username" value="',  Petadopter.currentUsername ,'">\n            <input type="hidden" id="commenter_id" name="commenter_id" value="',  userId ,'">\n            <input type="hidden" id="listing_id" name="listing_id" value="',  listing.id ,'">\n            <textarea id="body" name="body" rows="3" cols="42" placeholder="Enter your comment here"></textarea><br>\n            <button class="combut" name="Add Comment">Add Comment</button>\n          </fieldset>\n        </form>\n      </article>\n  ');  } ; __p.push('\n    </section>\n\n\n\n    <div id="dialog-confirm"></div>\n    <div id="photo-modal">\n    </div>\n</div>\n');}return __p.join('');};
}).call(this);
...
Petadopter.Views.Search = Backbone.View.extend({
  initialize: function () {
