...
(function() { this.JST || (this.JST = {}); this.JST["listings/comment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <br>\n  <h4>Comments</h4>\n  <ul>\n    ');  comments.each(function (comment) { ; __p.push('\n      <li>',  comment.escape('body') ,'</li>\n    ');  }) ; __p.push('\n  </ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="new_listing" title="',  listing.isNew() ? 'New Listing' : 'Edit Listing' ,'">\n  <form id="newListing">\n    <fieldset>\n\n      <input type="hidden" id="owner_id" name="owner_id" value="',  userId ,'">\n\n      <label>Pet\'s Name:\n      <input type="text" id="pet_name" name="pet_name" value="',  listing.escape('pet_name') ,'">\n      </label><br><br>\n\n      <label>Species:\n        <select id="species" name="species">\n          <option>Cat</option>\n          <option>Dog</option>\n          <option>Bird</option>\n          <option>Rodent</option>\n          <option>Reptile</option>\n          <option>Human</option>\n        </select>\n      </label><br><br>\n\n      <label>Breed:\n        <input id="breed" type="text" name="breed" value="',  listing.escape('breed') ,'">\n      </label><br><br>\n\n      <label>Age:\n        <input id="age" type="text" name="age" value="',  listing.escape('age') ,'">\n      </label><br><br>\n\n      <label>Location:\n        <input id="location" type="text" name="location" value="',  listing.escape('location') ,'">\n      </label><br><br>\n\n      Description:<br>\n      <label>\n        <textarea id="body" name="body" rows="6" cols="40">',  listing.escape('body') ,'</textarea>\n      </label><br>\n\n    </fieldset>\n  </form>\n  <button type="submit" form="newListing"></button>\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["listings/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n\n<div id="dialog" title="',  listing.escape('pet_name') ,'">\n  <p>\n    <strong>Animal: </strong>',  listing.escape('species') ,'<br>\n    <section class="location">\n      <strong>Location: </strong>',  listing.escape('location') ,'<br>\n    </section>\n    ');  if (listing.escape('breed') !== "")  { ; __p.push('\n        <strong>Breed: </strong>',  listing.escape('breed') ,'<br>\n    ');  } ; __p.push('\n    ');  if (listing.escape('age') !== "")  { ; __p.push('\n        <strong class="age">Age: </strong>',  listing.escape('age') ,'<br>\n    ');  } ; __p.push('\n    <br>\n    <strong>Description: </strong>',  listing.escape('body') ,'\n    </p>\n\n    <section class="comments">\n\n    </section>\n\n    <div id="dialog-confirm">\n\n    </div>\n\n\n</div>\n');}return __p.join('');};
}).call(this);
